...
*@FileName : CarrierMgmtDBDAOCarrierMgmtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierMgmtDBDAOCarrierMgmtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierMgmtDBDAOCarrierMgmtUSQL(){
		setQuery();
		...
		query.append("FileName : CarrierMgmtDBDAOCarrierMgmtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
