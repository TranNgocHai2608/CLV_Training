...
*@FileName : CarrierMgmtVO.java
*@FileTitle : CarrierMgmtVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esm.clv.practice1.CarrierMgmt.vo;
...
public class CarrierMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CarrierMgmtVO> models = new ArrayList<CarrierMgmtVO>();
	...
	public CarrierMgmtVO() {}

	public CarrierMgmtVO(String ibflag, String pagerows, String modiCostCtrCd, String edwUpdDt, String updUsrId, String updDt, String creUsrId, String creDt, String deltFlg, String joStlOptCd, String trdCd, String custSeq, String custCntCd, String vndrSeq, String rlaneCd, String joCrrCd, String sCreDtFm, String sCreDtTo) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public CarrierMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CarrierMgmtVO[]
	 */
	public CarrierMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CarrierMgmtVO model = null;
	...
	public CarrierMgmtVO[] getCarrierMgmtVOs(){
		CarrierMgmtVO[] vos = (CarrierMgmtVO[])models.toArray(new CarrierMgmtVO[models.size()]);
		return vos;
	}
