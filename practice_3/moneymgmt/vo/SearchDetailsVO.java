...
*@FileName : SearchDetailsVO.java
*@FileTitle : SearchDetailsVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esm.clv.practice1.moneymgmt.vo;
...
public class SearchDetailsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchDetailsVO> models = new ArrayList<SearchDetailsVO>();
	...
	public SearchDetailsVO() {}

	public SearchDetailsVO(String ibflag, String pagerows, String joCrrCd, String rlaneCd, String loclCurrCd, String invNo, String csrNo, String aproFlg, String custVndrCntCd, String custVndrSeq, String prnrRefNo, String custVndrEngNm, String invRevActAmt, String invExpActAmt, String revExp, String item, String acctYrmonFr, String acctYrmonTo, String trdCd) {
		this.csrNo = csrNo;
...
/**
	 ...
	 */
	public SearchDetailsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchDetailsVO[]
	 */
	public SearchDetailsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchDetailsVO model = null;
	...
	public SearchDetailsVO[] getSearchDetailsVOs(){
		SearchDetailsVO[] vos = (SearchDetailsVO[])models.toArray(new SearchDetailsVO[models.size()]);
		return vos;
	}
