...
*@FileName : MoneyMgmtDBDAOSearchDetailsVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MoneyMgmtDBDAOSearchDetailsVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MoneyMgmtDBDAOSearchDetailsVORSQL(){
		setQuery();
		...
		query.append("FileName : MoneyMgmtDBDAOSearchDetailsVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
