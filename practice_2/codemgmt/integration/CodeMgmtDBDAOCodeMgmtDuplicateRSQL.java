...
*@FileName : CodeMgmtDBDAOCodeMgmtDuplicateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeMgmtDuplicateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeMgmtDuplicateRSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeMgmtDuplicateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
