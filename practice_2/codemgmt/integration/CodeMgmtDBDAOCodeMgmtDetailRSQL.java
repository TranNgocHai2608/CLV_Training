...
*@FileName : CodeMgmtDBDAOCodeMgmtDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeMgmtDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeMgmtDetailRSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeMgmtDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
