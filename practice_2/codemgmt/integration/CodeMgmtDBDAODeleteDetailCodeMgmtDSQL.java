...
*@FileName : CodeMgmtDBDAODeleteDetailCodeMgmtDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAODeleteDetailCodeMgmtDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAODeleteDetailCodeMgmtDSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAODeleteDetailCodeMgmtDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
