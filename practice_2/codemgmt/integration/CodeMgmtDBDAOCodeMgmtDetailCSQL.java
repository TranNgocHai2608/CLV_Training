...
*@FileName : CodeMgmtDBDAOCodeMgmtDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeMgmtDetailCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeMgmtDetailCSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeMgmtDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
