...
*@FileName : CodeMgmtDBDAOCodeMgmtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeMgmtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeMgmtUSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeMgmtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
