...
*@FileName : CodeMgmtVO.java
*@FileTitle : CodeMgmtVO
*Open Issues :
*Change history :
...
public class CodeMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CodeMgmtVO> models = new ArrayList<CodeMgmtVO>();
	...
	public CodeMgmtVO(String ibflag, String pagerows, String updDt, String updUsrId, String creDt, String creUsrId, String intgCdUseFlg, String mngTblNm, String ownrSubSysCd, String intgCdLen, String intgCdDatTpNm, String intgCdTpCd, String intgCdDesc, String intgCdNm, String intgCdId) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return CodeMgmtVO[]
	 */
	public CodeMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CodeMgmtVO[]
	 */
	public CodeMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CodeMgmtVO model = null;
	...
	public CodeMgmtVO[] getCodeMgmtVOs(){
		CodeMgmtVO[] vos = (CodeMgmtVO[])models.toArray(new CodeMgmtVO[models.size()]);
		return vos;
	}
